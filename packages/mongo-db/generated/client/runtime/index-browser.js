  ...
  Xe = (e, n, i, t) => {
    if ((n && typeof n == "object") || typeof n == "function")
      for (let r of Ge(n))
        !Je.call(e, r) &&
          r !== i &&
          he(e, r, { get: () => n[r], enumerable: !(t = We(n, r)) || t.enumerable });
    return e;
  };
...
h.times = h.mul = function (e) {
  ...
  for (t = f; --t >= 0; ) {
    for (n = 0, r = l + t; r > t; )
      (u = s[r] + g[t] * d[r - t - 1] + n), (s[r--] = u % L | 0), (n = (u / L) | 0);
    s[r] = (s[r] + n) % L | 0;
  }
  for (; !s[--o]; ) s.pop();
...
var S = (function () {
  ...
  return function (t, r, s, o, u, l) {
    ...
    for (
      l ? ((g = 1), (c = t.e - r.e)) : ((l = L), (g = m), (c = R(t.e / g) - R(r.e / g))),
        T = k.length,
        W = b.length,
        M = new ee(de),
        q = M.d = [],
    ...
    if (
      ...
      if (((I = (I / g + 2) | 0), (a = 0), T == 1)) {
        ...
        for (
          d = (l / (k[0] + 1)) | 0,
            d > 1 && ((k = e(k, d, l)), (b = e(b, d, l)), (T = k.length), (W = b.length)),
            z = T,
            E = b.slice(0, T),
            P = E.length;
          P < T;
...
function Ue(e, n, i, t) {
  var r,
    ...
    o = Math.ceil(t / m + 4);
  for (w = !1; ; ) {
    if ((i % 2 && ((s = s.times(n)), _e(s.d, o) && (r = !0)), (i = R(i / 2)), i === 0)) {
