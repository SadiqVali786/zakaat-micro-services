...
export default function VideoCallPage() {
  ...
  return (
    <div className="bg-neutral-11 flex h-[99%] w-full items-center justify-center sm:bg-transparent">
      {callStatus === WebRTCCallStatus.Incoming && <RenderIncomingCallStatus timeLeft={timeLeft} />}
      <VideoCallScreen
